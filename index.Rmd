...
```{r}
library(tidyverse)
iowa_votes_study <- read_csv("State_of_Iowa_-_Monthly_Voter_Registration_Totals_by_State_Senate_District.csv", show_col_types = FALSE)
iowa_votes_study
...
filter by political party -- see if any registered democrats or independent voters in these towns decided to vote R after the introduction of Fox News in the area.  
